 ...
 * @author Neo_
 */
public class SearchComboSpecial {
    private ArrayList<String> arrayList;
    private JTextField txt;

    public SearchComboSpecial() {
    }

    public void setSearchableCombo(final JComboBox comboBox, boolean mustSort, final JButton enterButton , final JButton focusButton) {
        ...
        txt.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent evt) {
             ...
             public void keyPressed(KeyEvent evt) {
                 if(Validate.validateLetters(txt.getText()+ evt.getKeyChar())){
