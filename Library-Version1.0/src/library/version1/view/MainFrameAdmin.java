...
//        setAuthorList();
    ...
    private void initComponents() {
        ...
        settingButton.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        settingButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/profile_64x64.png"))); // NOI18N
        settingButton.setText("Settings");
        settingButton.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 0, 0), null, null, new java.awt.Color(255, 255, 0)));
        ...
        borrowBook.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Library- icon.png"))); // NOI18N
        ...
        receiveBook.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Aqua-Smooth-Folder-Library-icon.png"))); // NOI18N
        receiveBook.setText("Receive Book");
        receiveBook.setBorderPainted(false);
        receiveBook.setContentAreaFilled(false);
        receiveBook.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        reportsButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/library.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/resizer-nl9eca4fc7a48ea0a.jpg"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(borrowBook, javax.swing.GroupLayout.PREFERRED_SIZE, 407, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(reportsButton, javax.swing.GroupLayout.PREFERRED_SIZE, 407, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(54, 54, 54)
                        .addComponent(receiveBook, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(13, 13, 13)
                        .addComponent(borrowBook, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        setAuthorList();    // TODO add your handling code here:
    ...
    private void settingButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_settingButtonMouseEntered
        createSettingsMenu();        // TODO add your handling code here:
    ...
    private void createMenu(Component component,final String menu){
        ...
        add.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                switch(menu){
                    case "Book"     : new AddBook(MainFrameAdmin.this,true).setVisible(true);
                                      break;
                    case "Member"   : new AddMember(MainFrameAdmin.this, true).setVisible(true);
                                      break;
                    case "Author"   : new AddAuthor(MainFrameAdmin.this, true).setVisible(true);
                                      break;
                    case "Category" : new AddCategory(MainFrameAdmin.this, true).setVisible(true);
                                      break;    
               }
            }
        }); 
        ...
        if(menu.equals("Book")){
            ...
            duplicateBook.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    new DuplicateBook(MainFrameAdmin.this, true).setVisible(true);
                }
            });
        ...
        if(menu!="Author" && menu!="Category"){
            ...
            search.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                   switch(menu){
                          case "Book"     : new SearchBook(MainFrameAdmin.this, true).setVisible(true);
                                            break;
                          case "Member"   : new SearchMember(MainFrameAdmin.this, true).setVisible(true);
                                            break;
                   }
                }
            });
        ...
        view.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              switch(menu){
                      case "Book"     : new ViewBook(MainFrameAdmin.this, true).setVisible(true);
                                        break;
                      case "Member"   : new ViewMember(MainFrameAdmin.this, true).setVisible(true);
                                        break;
                      case "Author"   : new ViewAuthor(MainFrameAdmin.this, true).setVisible(true);
                                        break;
                      case "Category" : new ViewCategory(MainFrameAdmin.this, true).setVisible(true);
                                        break;
               }
            }
        });
    ...
    private void showMenuNice(Component component, final JPopupMenu menu,int size){
     ...
     private void createSettingsMenu(){
        ...
        TransparentMenuItem accounts=new TransparentMenuItem("Accounts Settings");
        accounts.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                 new AccountSettings(MainFrameAdmin.this, true).setVisible(true);
            
            }
        }); 
        PopUpMenu.add(accounts);
        accounts.setMnemonic('A');
        ImageIcon imageView1 = new ImageIcon("./src/icons/options-icon.png");            
        accounts.setIcon(imageView1);
        
        
        
        TransparentMenuItem options=new TransparentMenuItem("Options");
        options.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                 new SoftOptions(MainFrameAdmin.this, true).setVisible(true);
            }
        }); 
        PopUpMenu.add(options);
        options.setMnemonic('O');
        ImageIcon imageView2 = new ImageIcon("./src/icons/Internet-Options-icon.png");            
        options.setIcon(imageView2);
        
        TransparentMenuItem backupSystem=new TransparentMenuItem("Backup System");
        backupSystem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                 new BackUpProgramme(null,true).setVisible(true);
            }
        }); 
        PopUpMenu.add(backupSystem);
        backupSystem.setMnemonic('B');
        ImageIcon imageView4 = new ImageIcon("./src/icons/cd-burner-copy-icon.png");            
        backupSystem.setIcon(imageView4);

        
        TransparentMenuItem monthlyReport=new TransparentMenuItem("MonthlyReport");
        monthlyReport.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                 new MonthlyReport(MainFrameAdmin.this, true).setVisible(true);
            }
        }); 
        PopUpMenu.add(monthlyReport);
        monthlyReport.setMnemonic('R');
        ImageIcon imageView3 = new ImageIcon("./src/icons/My-Documents-icon.png");            
        monthlyReport.setIcon(imageView3);
    
        showMenuNice(settingButton,PopUpMenu,PopUpMenu.getComponentCount());
