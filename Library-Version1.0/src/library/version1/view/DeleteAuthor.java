...
public class DeleteAuthor extends javax.swing.JDialog {
     ...
     */
    public DeleteAuthor(java.awt.Frame parent, boolean modal, String aId) {
        super(parent, modal);
        initComponents();
        
         setTitle("Delete Author Form");
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Delete Author");
        ...
        editButton.setText("Delete Author");
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        String authorId=idText.getText();
        int warn =JOptionPane.showConfirmDialog(this, "You will loose your all books of this Author !", "Delete Author", JOptionPane.OK_CANCEL_OPTION);
        if(warn==JOptionPane.OK_OPTION){
            try {
                int result=AuthorController.deleteAuthor(authorId);
                if(result==1){
                    JOptionPane.showMessageDialog(this, "Author Deleted", "Deleted Message",JOptionPane.INFORMATION_MESSAGE);
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DeleteAuthor dialog=null;
                
                dialog = new DeleteAuthor(new javax.swing.JFrame(), true, null);
