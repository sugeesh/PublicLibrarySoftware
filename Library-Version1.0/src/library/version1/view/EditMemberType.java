 ...
 * @author Neo_
 */
public class EditMemberType extends javax.swing.JDialog {
   
    /**
     * Creates new form AddMemberType
     */
    public EditMemberType(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
     ...
     public EditMemberType(java.awt.Frame parent, boolean modal, MemberType memberType) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Edit Member Type");
    ...
    private void setNewForm( MemberType memberType){
        idText.setText(memberType.getId());
        typeText.setText(memberType.getType());
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        try {
            int result =MemberTypeController.updateMemberType(memberType);
            if(result==1){
                JOptionPane.showMessageDialog(this, "Memeber Type Updated");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditMemberType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditMemberType dialog = new EditMemberType(new javax.swing.JFrame(), true);
