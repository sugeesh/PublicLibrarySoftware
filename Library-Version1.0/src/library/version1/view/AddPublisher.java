...
public class AddPublisher extends javax.swing.JDialog {
    ...
    public AddPublisher(java.awt.Frame parent, boolean modal) {
        ...
        setTitle("Add Publisher Form");
        setLocationRelativeTo(parent);
        
        setNewForm();
    }
    
    public AddPublisher(java.awt.Frame parent, boolean modal, int close) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        titleLabel.setText("New Publisher");
    ...
    private void setNewForm(){
        ...
        addButton.setEnabled(false);
        try {
            idText.setText(IdGenarate.getId("P", "PId","Publisher"));
