...
public class AddMember extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        addMemberTabPane = new javax.swing.JTabbedPane();
        ...
        addMemberTabPane.addTab("Personal", personalDetailsPanel);
        ...
        memberTypeCombo.setEnabled(false);
        ...
        guarantorCombo.setEnabled(false);
        guarantorCombo.setNextFocusableComponent(addButton);
        ...
        addMemberTypeButton.setEnabled(false);
        ...
        addGuarantorButton.setEnabled(false);
        ...
        renewDateChooser.setEnabled(false);
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Registered"));

        dobLabel.setText("Registered Date");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(receiptNoLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(dobLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(receiptNoText)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(dobLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(receiptNoLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(receiptNoText, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
                ...
                .addGroup(otherDetailPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(otherDetailPanelLayout.createSequentialGroup()
                        .addGroup(otherDetailPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(reNewDateLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(guarantorLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(memberTypeLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE))
                        .addGap(19, 19, 19)
                        .addGroup(otherDetailPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(otherDetailPanelLayout.createSequentialGroup()
                                .addComponent(guarantorCombo, 0, 482, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(addGuarantorButton, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(otherDetailPanelLayout.createSequentialGroup()
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, otherDetailPanelLayout.createSequentialGroup()
                                .addComponent(memberTypeCombo, 0, 482, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        otherDetailPanelLayout.setVerticalGroup(
            ...
            .addGroup(otherDetailPanelLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(otherDetailPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(guarantorLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(guarantorCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        addMemberTabPane.addTab("Other", otherDetailPanel);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(titleLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 753, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(addMemberTabPane, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(addMemberTabPane, javax.swing.GroupLayout.PREFERRED_SIZE, 377, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void setForm(){
        ...
        guarantorCombo.setSelectedIndex(0);
        memberNumberText.setEnabled(true);
        nameText.setEnabled(false);
        addressText.setEnabled(false);
        dobChooser.setEnabled(false);
        renewDateChooser.setEnabled(false);
    ...
    private void enableAddButton(){
         if(number && name && address && memberType && guarantor ){
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        try {
            int result = MemberController.addMember(member,receiptNoText.getText());
            if(result==1){
                JOptionPane.showMessageDialog(this, "New Member Added", "Add New Member", 1);
            }
            setForm();
        } catch (ClassNotFoundException ex) {
            JOptionPane.showMessageDialog(this, "Connection Error ","Error Message", JOptionPane.ERROR_MESSAGE);
        ...
        addMemberTabPane.setSelectedIndex(0);
        this.dispose();
        new AddMember(null, true).setVisible(true);
        System.gc();
    ...
    private void addGuarantorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addGuarantorButtonActionPerformed
        AddGuarantor addGuarantor = new AddGuarantor(null,true,1);         // TODO add your handling code here:
        addGuarantor.setVisible(true);
        initGuarantorCombo();
        guarantorCombo.setSelectedItem(addGuarantor.name);
        System.out.println(addGuarantor.name);;
    ...
    private void memberNumberTextKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_memberNumberTextKeyReleased
        if(!memberNumberText.getText().isEmpty()){         
            try {
                if(!MemberController.checkMember(memberNumberText.getText())){ 
                    number=true;
                    nameText.setEnabled(true);
                    addressText.setEnabled(true);
                    dobChooser.setEnabled(true);
                    renewDateChooser.setEnabled(true);
                    memberTypeCombo.setEnabled(true);
                    guarantorCombo.setEnabled(true);  
                    addGuarantorButton.setEnabled(true);
                    addMemberTypeButton.setEnabled(true);// TODO add your handling code here:
                }else{
                    number=false;
                    nameText.setEnabled(!true);
                    addressText.setEnabled(!true);
    ...
    private void nameTextKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nameTextKeyReleased
        ...
        enableAddButton();      // TODO add your handling code here:
    ...
    private void nextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextButtonActionPerformed
        addMemberTabPane.setSelectedIndex(1);        // TODO add your handling code here:
    ...
    private javax.swing.JTabbedPane addMemberTabPane;
